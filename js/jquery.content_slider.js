...
// ----------------- Content Slider main class ---------------------------
	function content_slider(element, options) {
		...
		if (this.options.allow_shadow==0) {
			this.$prettyPhoto_div.css('box-shadow', '0px 0px 5px #585858');
		}
	...
	content_slider.prototype = {
		...
		_create_arrows : function () {
			...
			if (this.options.hv_switch) {
				...
				if (this.options.border_on_off==0 || this.options.use_thin_arrows==1) {
					html = '<div class="circle_slider_nav_left"><img src="'+this.options.plugin_url+'images/arr-left1.png" alt="left" /></div>';
					html += '<div class="circle_slider_nav_right"><img src="'+this.options.plugin_url+'images/arr-right1.png" alt="right" /></div>';
				} else {
